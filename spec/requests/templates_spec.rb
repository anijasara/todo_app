...
RSpec.describe "/templates", type: :request do
  ...
  # TemplatesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get templates_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Template" do
        expect {
          post templates_url,
               params: { template: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Template" do
        expect {
          post templates_url,
               params: { template: invalid_attributes }, as: :json
        }.to change(Template, :count).by(0)
      end

      it "renders a JSON response with errors for the new template" do
        post templates_url,
             params: { template: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested template" do
      template = Template.create! valid_attributes
      expect {
        delete template_url(template), headers: valid_headers, as: :json
      }.to change(Template, :count).by(-1)
    end
  end
end
